...
module.exports.host = (ip, key, opts = {}) => {
  ...
  if (!ip) {
    return Promise.reject(utils.createErrMandatory('ip'));
  }
  if (!key) {
    return Promise.reject(utils.createErrMandatory('key'));
  }
...
module.exports.search = (query, key, opts = {}) => {
  ...
  if (!query) {
    return Promise.reject(utils.createErrMandatory('query'));
  }
...
module.exports.ports = (key, opts = {}) =>
  utils.apiRequest(apiSection, '/shodan/ports?', key, opts.timeout);

module.exports.protocols = (key, opts = {}) =>
...
module.exports.scan = (ips, key, opts = {}) => {
  ...
  if (!ips) {
    return Promise.reject(utils.createErrMandatory('ips'));
  }
...
module.exports.scanInternet = (port, protocol, key, opts = {}) => {
  ...
  if (!port) {
    return Promise.reject(utils.createErrMandatory('port'));
  }
  if (!protocol) {
    return Promise.reject(utils.createErrMandatory('protocol'));
  }
...
module.exports.services = (key, opts = {}) =>
...
module.exports.accountProfile = (key, opts = {}) =>
...
module.exports.dnsResolve = (hostnames, key, opts = {}) => {
  ...
  if (!hostnames) {
    return Promise.reject(utils.createErrMandatory('hostnames'));
  }
...
module.exports.toolsMyip = (key, opts = {}) =>
  utils.apiRequest(apiSection, '/tools/myip?', key, opts.timeout);

module.exports.apiInfo = (key, opts = {}) =>
