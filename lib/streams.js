...
module.exports.ports = (ports, key, opts = {}) => {
  ...
  if (!ports) {
    return Promise.reject(utils.createErrMandatory('ports'));
  }
...
module.exports.asn = (asn, key, opts = {}) => {
  ...
  if (!asn) {
    return Promise.reject(utils.createErrMandatory('asn'));
  }
...
module.exports.countries = (countries, key, opts = {}) => {
  ...
  if (!countries) {
    return Promise.reject(utils.createErrMandatory('countries'));
  }
